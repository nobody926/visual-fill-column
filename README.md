...
--------------------------------- | -------------------------------
 ![screenshot before](images/before.png) | ![screenshot after](images/after.png)
...
--------------------------------- | -------------------------------
 ![without adaptive-wrap](images/no-adaptive-wrap.png) | ![with adaptive-wrap](images/adaptive-wrap.png)
...
![screenshot after](images/centred.png)
